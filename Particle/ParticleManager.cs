...
{
    private readonly List<global::Aritix.Particle.Particle> _particles = new List<global::Aritix.Particle.Particle>();
    private readonly List<ParticleEmitter> _particleEmitters = new List<ParticleEmitter>();

    public void AddParticle(global::Aritix.Particle.Particle particle)
    {
